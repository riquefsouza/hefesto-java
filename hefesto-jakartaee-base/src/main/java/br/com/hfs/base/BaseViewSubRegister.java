...
public abstract class BaseViewSubRegister<P, T, I extends Serializable, B extends BaseService<T, I, ? extends BaseRepository<T, I>>>
	 ...
	 *            the pagina editar
	 */
	public BaseViewSubRegister(String pageEdit) {
		super();
	 ...
	 * Dialogo.
	 *
	 * @param entityParent the entity pai
	 * @param entity the entity
	 * @param incluir the incluir
	 */
	protected void dialog(P entityParent, T entity, boolean incluir) {
		this.dialog(entityParent, entity, incluir, "");
	}

	protected void dialog(P entityParent, T entity, boolean incluir, String contentHeight) {
 ...
 */
	...
	public void dialogInsert(P entityParent, T entity, String contentHeight) {
		this.dialog(entityParent, entity, true, contentHeight);
	}
	...
	public void dialogEdit(P entityParent, T entity, String contentHeight) {
		this.dialog(entityParent, entity, false, contentHeight);		
	}
